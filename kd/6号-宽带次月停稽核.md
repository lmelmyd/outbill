...
## uop_act1
select db,count(1) from jinl_f_User_Otherinfo_all group by db;
act1    194455
act2    190513
act3    284807
act4    161884

select db,trade_type_code,count(1) from Tf_b_Credittrade_Local4g_all 
where trade_type_code in ('7150', '7140', '7350') group by db,trade_type_code;
